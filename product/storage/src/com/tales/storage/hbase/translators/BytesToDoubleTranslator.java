...
public class BytesToDoubleTranslator extends NullTranslatorBase implements Translator {

	public BytesToDoubleTranslator( ) {
		this( null );
	}
	public BytesToDoubleTranslator( Object theNullValue) {
		super( theNullValue );
	}
		...
		if( anObject == null ) {
			...
			try {
				...
				if( value.length == 0) {
					...
					returnValue = Bytes.toDouble( value );
				}
