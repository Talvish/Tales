...
public class BytesToLongTranslator extends NullTranslatorBase implements Translator {

	public BytesToLongTranslator( ) {
		this( null );
	}
	public BytesToLongTranslator( Object theNullValue) {
		super( theNullValue );
	}
		...
		if( anObject == null ) {
			...
			try {
				...
				if( value.length == 0) {
					...
					returnValue = Bytes.toLong( value );
				}
