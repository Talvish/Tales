...
public class BytesToBooleanTranslator extends NullTranslatorBase implements Translator {

	public BytesToBooleanTranslator( ) {
		this( null );
	}
	public BytesToBooleanTranslator( Object theNullValue) {
		super( theNullValue );
	}
		...
		if( anObject == null ) {
			...
			try {
				...
				if( value.length == 0) {
					...
					returnValue = Bytes.toBoolean( value );
				}
