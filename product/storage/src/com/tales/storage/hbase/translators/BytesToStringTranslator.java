...
public class BytesToStringTranslator extends NullTranslatorBase implements Translator {

	public BytesToStringTranslator( ) {
		this( null );
	}
	public BytesToStringTranslator( Object theNullValue) {
		super( theNullValue );
	}
		...
		if( anObject == null ) {
			...
			try {
				...
				if( value.length == 0) {
					...
					returnValue = Bytes.toString( value );
				}
