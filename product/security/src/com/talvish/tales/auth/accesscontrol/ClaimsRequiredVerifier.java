...
/**
 * A verifier that checks to make sure that certain claims exist on 
 * a json web token.
 * @author jmolnar
 *
 */
public class ClaimsRequiredVerifier implements ClaimVerifier {
	 ...
	 */
	public ClaimsRequiredVerifier( String... theClaims ) {
	...
	/**
	 * Verifies that the json web token contains the identified claims.
	 */
	@Override
