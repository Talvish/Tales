...
/**
 * Translator that converts a String into a Json Primitive
 * or if null, then {@code JsonNull}.
 * @author jmolnar
 *
 */
public class StringToJsonPrimitiveTranslator implements Translator {
	/**
	 * Empty default constructor.
	 */
	public StringToJsonPrimitiveTranslator( ) {
	}
