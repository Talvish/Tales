...
*
*/
public class JsonElementToIntegerTranslator extends NullTranslatorBase implements Translator {
	/**
	 ...
	 */
	public JsonElementToIntegerTranslator( Object theNullValue ) {
		super( theNullValue );
	}
	...
	public Object translate(Object anObject) {
		...
		if( anObject == null || anObject.equals( JsonNull.INSTANCE )) {
			...
			try {
				returnValue = ( ( JsonElement )anObject ).getAsInt();
