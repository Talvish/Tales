...
*
*/
public class JsonElementToFloatTranslator extends NullTranslatorBase implements Translator {
	/**
	 ...
	 */
	public JsonElementToFloatTranslator( Object theNullValue ) {
		super( theNullValue );
	}
	...
	public Object translate(Object anObject) {
		...
		if( anObject == null || anObject.equals( JsonNull.INSTANCE )) {
			...
			try {
				returnValue = ( ( JsonElement )anObject ).getAsFloat();
