...
*
*/
public class JsonElementToDateTimeTranslator extends NullTranslatorBase implements Translator {
	private final StringToDateTimeTranslator dateTimeTranslator;
	/**
	 ...
	 */
	public JsonElementToDateTimeTranslator( Object theNullValue ) {
		super( theNullValue );
		dateTimeTranslator = new StringToDateTimeTranslator( true, theNullValue, theNullValue );
	}
	...
	public Object translate(Object anObject) {
		...
		if( anObject == null || anObject.equals( JsonNull.INSTANCE )) {
			...
			try {
				returnValue = dateTimeTranslator.translate( ( ( JsonElement )anObject ).getAsString( ) );
