...
*
*/
public class JsonElementToBooleanTranslator extends NullTranslatorBase implements Translator {
	/**
	 ...
	 */
	public JsonElementToBooleanTranslator( Object theNullValue ) {
		super( theNullValue );
	}
	...
	public Object translate(Object anObject) {
		...
		if( anObject == null || anObject.equals( JsonNull.INSTANCE )) {
			...
			try {
				returnValue = ( ( JsonElement )anObject ).getAsBoolean();
