...
/**
 * A base class for the Min annotation validators.
 * @author jmolnar
 *
 * @param <T> the type of value (e.g. int, long, etc)
 */
public abstract class MinValidator<T> implements ValueValidator<T> {
	...
	public void generateMessageFragment( T theValue, StringBuilder theBuilder ) {
		...
		theBuilder.append( " is not greater than or equal to ");
