...
public class StringToByteArrayTranslator extends StringToObjectTranslatorBase implements Translator {
	...
	public StringToByteArrayTranslator( boolean shouldTrim, Object theEmptyValue, Object theNullValue) {
		...
		if( anObject == null ) {
			...
			try {
				...
				if( stringValue.equals("") ) {
					...
					returnValue = DatatypeConverter.parseHexBinary( stringValue );
				}
			} catch( IllegalArgumentException e ) {
				throw new TranslationException( String.format( "Unable to translate '%s' into a byte array.", anObject ), e);
